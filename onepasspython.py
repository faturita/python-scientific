...
hw = hello + ' ' + world + str(2)  # String concatenation
print(hw)          # prints "hello world"
hw12 = '%s %s %d' % (hello, world, 12)  # sprintf style string formatting
print(hw12)        # prints "hello world 12"
print (hw[0:1])    # Strings allow some slicing  [0,1)
print (hw[0:-1])
print (hw[0:])
...
print('Map takes the first parameters which is a function...')
print('...and applies that to all the elements in the list.')
...
gen = (x ** 2 for x in range(100))          # Generator comprehension
